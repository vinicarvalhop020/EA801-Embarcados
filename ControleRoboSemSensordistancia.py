...
def main_loop():
    ...
    global TOLeg1B, TOLeg2B, TOLeg3B, TOLeg4B
    global TOLeg1F, TOLeg2F, TOLeg3F, TOLeg4F  
    
    while True:
        check_uart()
        print("Comando recebido:", reccmd)
        print("Walkstep:", walkstep, "Walkstep2:", walkstep2)  # Debug
        ...
        if reccmd in ["F", "B", "L", "R", "G", "I", "H", "J"]:
            print("Processando comando de movimento")  # Debug
            if reccmd in ["F", "L", "G", "I"]:
                ...
                if walkstep2 < 1:
                    walkstep2 += 7
            print("Passos atualizados:", walkstep, walkstep2)  # Debug


            if reccmd in ["F", "B"]:
                print("Movimento F/B")  # Debug
